        ...
        <div class="settings-main">
          ...
          <div class="action-grid">
            <article class="action-card">
              ...
              @if (komootAuth.connectionState(); as state) {
                ...
                <div class="action-card-bottom">
                  <button class="btn btn-danger" type="button" (click)="disconnectKomoot()">Disconnect</button>
                </div>
                ...
                <div class="auth-form">
                  ...
                  <button class="btn btn-primary btn-block" type="button" [disabled]="!komootEmail() || !komootPassword() || komootAuth.isConnecting()" (click)="connectKomoot()">
            ...
            <article class="action-card">
              ...
              <h3 class="action-card-title">Sync tours</h3>
              <p class="action-card-desc">Import new Komoot tours and their GPS routes.</p>
              <div class="action-card-bottom">
                <button class="btn btn-primary" type="button" [disabled]="!komootAuth.connectionState()" (click)="syncNewActivities()">Sync tours</button>
              </div>
            </article>
          </div>

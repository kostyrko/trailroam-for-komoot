...
import { KomootAuthCardComponent } from './komoot-auth-card.component';

@Component({
  selector: 'app-settings-page',
  imports: [KomootAuthCardComponent],
  styles: [`
          ...
          <div class="action-grid">
            ...
            <article class="action-card">
              ...
              <div class="action-card-bottom">
                <button class="btn btn-primary" type="button" [disabled]="!authService.connectionState()" (click)="syncNewActivities()">Sync tours</button>
              </div>
            </article>
          </div>
...
export class SettingsPage {
  ...
  protected syncNewActivities(): void {
    this.syncService.syncNewTours().then(() => this.loadSyncHistory());
  }

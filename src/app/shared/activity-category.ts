...
const KOMOOT_SPORT_CATEGORY_MAP: Record<string, ActivityCategory> = {
  racebike: 'ride',
  e_racebike: 'ride',
  mtb: 'ride',
  e_mtb: 'ride',
...
export function mapKomootSportToCategory(sportType: string): ActivityCategory {
  return KOMOOT_SPORT_CATEGORY_MAP[sportType] ?? 'other';
}
